...
public class HistorialController {
    ...
    @FXML
    private TableView<HistorialMovimiento> tblHistorial;
    @FXML
    private TableColumn<HistorialMovimiento, Long> colId;
    @FXML
    private TableColumn<HistorialMovimiento, String> colFechaHora;
    @FXML
    private TableColumn<HistorialMovimiento, String> colUsuario;
    @FXML
    private TableColumn<HistorialMovimiento, String> colModulo;
    @FXML
    private TableColumn<HistorialMovimiento, String> colAccion;
    @FXML
    private TableColumn<HistorialMovimiento, String> colDescripcion;
    ...
    private void handleBuscar() {
        ...
        if (!terminoBusqueda.isEmpty()) {
            movimientos = movimientos.stream()
                    .filter(m -> m.getAccion().toLowerCase().contains(terminoBusqueda) ||
