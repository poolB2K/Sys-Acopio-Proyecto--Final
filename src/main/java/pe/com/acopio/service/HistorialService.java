...
public class HistorialService {
     ...
     * El usuario debe ser proporcionado por la capa que llama al servicio (ej.
     * Controller).
     *
     ...
     * @param modulo      El módulo del sistema donde ocurrió la acción (ej.
     *                    "ACOPIO").
     */
    @Transactional
    public void logAccion(Usuario usuario, String accion, String descripcion, String modulo) {
        logAccion(usuario, accion, descripcion, modulo, null);
    }

    /**
     * Registra una acción en el historial con detalles adicionales.
     *
     * @param usuario             El usuario que realiza la acción.
     * @param accion              El tipo de acción (ej. "REGISTRO_ACOPIO").
     * @param descripcion         Un detalle de la acción.
     * @param modulo              El módulo del sistema donde ocurrió la acción (ej.
     *                            "ACOPIO").
     * @param detallesAdicionales Información adicional en formato JSON (ej.
     *                            {"acopioId": 123})
     */
    @Transactional
    public void logAccion(Usuario usuario, String accion, String descripcion, String modulo,
        ...
        if (usuario == null) {
            ...
            // throw new IllegalArgumentException("El usuario no puede ser nulo para
        ...
        movimiento.setDetallesAdicionales(detallesAdicionales);
